...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiamVyZW15LW5ldmFkbyIsImEiOiJja2VubDE2NXQwMDV3MnpvaW9oeG5pbnB4In0.Gy2tV-W-P57OJsXdXI54Fw';
...
var stripe = String('pk_test_51HQzTrHkBSIJU1rRcYXeMEV5O8zktzrxjE4ltnsJFdNvRgLewPzJN4jNfh84YLFx3N7G59cGUW1kLo9O7EYGjKlH00EorsDjJT');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0, _axios.default)("http://localhost/api/v1/bookings/checkout-session/".concat(tourId));

          case 2:
            sessiong = _context.sent;
